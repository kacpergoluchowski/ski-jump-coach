        ...
        <div>
            {countriesData && (
                <div>
                    ...
                    { budgetSectDisplay && (
                        <Budget data = {budgetData} setBudgetState = {setBudgetSectDisplay} setChangeSectDisplay = {setChangeSectDisplay}/>
                    )}
                    { competitorsSectDisplay && (
                        <Competitors data = {competitorsData} setCompetitorsState = {setCompetitorsSectDisplay} setChangeSectDisplay = {setChangeSectDisplay}/>
                    )}
                    { hillsSectDisplay && (
